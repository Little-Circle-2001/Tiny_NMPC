...
s=patch(mian2x,mian2y,mian2z,'k','FaceAlpha',alpha);
rotate(s,dire,xuanzhuan,[XX(1),XX(2),XX(3)]);
hold on
...
s=patch(mian3x,mian3y,mian3z,'k','FaceAlpha',alpha);
rotate(s,dire,xuanzhuan,[XX(1),XX(2),XX(3)]);
hold on
...
s=patch(mian4x,mian4y,mian4z,'k','FaceAlpha',alpha);
rotate(s,dire,xuanzhuan,[XX(1),XX(2),XX(3)]);
hold on
...
s=patch(mian5x,mian5y,mian5z,'k','FaceAlpha',alpha);
rotate(s,dire,xuanzhuan,[XX(1),XX(2),XX(3)]);
hold on
...
s=patch(mian6x,mian6y,mian6z,'k','FaceAlpha',alpha);
rotate(s,dire,xuanzhuan,[XX(1),XX(2),XX(3)]);
hold on
...
yi1z = ones(1,4)*(XX(3));
s=patch(yi1x,yi1y,yi1z,'k','FaceAlpha',2*alpha);
rotate(s,dire,xuanzhuan,[XX(1),XX(2),XX(3)]);
hold on
...
yi2z = ones(1,4)*(XX(3));
s=patch(yi2x,yi2y,yi2z,'k','FaceAlpha',2*alpha);
rotate(s,dire,xuanzhuan,[XX(1),XX(2),XX(3)]);
hold on
