...
plot3(xlog(1,:),xlog(2,:),xlog(3,:),'Marker','o','LineStyle','-', 'LineWidth', 1.5 , 'Color','r');
plot3(xr(1,:),xr(2,:),xr(3,:),'LineStyle','--', 'LineWidth', 1.5 , 'Color','b');
grid on;
